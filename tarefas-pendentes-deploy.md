...
- Deploy das DEP-018, DEP-019 e DEP-020 realizado em produção com sucesso em 2026-05-19 via `./deploy-local.sh "chore: aplicar DEP-018, DEP-019 e DEP-020 e atualizar tarefas-pendentes-deploy.md"`.
- Commit de deploy DEP-018/019/020: `760792b` (push em `main`, build na VPS OK, PM2 reload OK).
- Deploy da DEP-021 realizado em produção com sucesso em 2026-05-19 via `./deploy-local.sh "chore: aplicar correcao de estabilidade do overview (marketReplacement seguro) e atualizar tarefas-pendentes-deploy.md"`.

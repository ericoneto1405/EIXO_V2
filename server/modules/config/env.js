...
export const CNPJ_LOOKUP_WINDOW_MS = Number(process.env.CNPJ_LOOKUP_WINDOW_MS) || 10 * 60 * 1000;
export const CNPJ_LOOKUP_MAX_PER_IP = Number(process.env.CNPJ_LOOKUP_MAX_PER_IP) || 15;

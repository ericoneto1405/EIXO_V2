...
const OnboardingSpotlight: React.FC<OnboardingSpotlightProps> = ({
    ...
    <div className="mx-auto w-full max-w-md rounded-[24px] border-2 border-[#B6E23A] bg-[var(--eixo-surface)] p-8 shadow-md transition-all duration-200 hover:-translate-y-1 hover:scale-[1.02]">
        ...
        <button
            type="button"
            onClick={onAction}
            className="mt-6 inline-flex items-center rounded-xl border-2 border-[#5a8c00] bg-[#B6E23A] px-6 py-3 font-bold text-[#1a1a1a] shadow-md transition-all duration-200 hover:bg-[#a3d130] hover:shadow-lg"
        >
            {actionLabel}
        </button>

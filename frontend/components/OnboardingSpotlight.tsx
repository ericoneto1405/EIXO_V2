...
const OnboardingSpotlight: React.FC<OnboardingSpotlightProps> = ({
    ...
    <div className="mx-auto w-full max-w-md rounded-[24px] border-t border-r border-b border-[#B6E23A]/40 border-l-4 border-l-[#B6E23A] bg-[var(--eixo-surface)] p-8 shadow-sm">
        ...
        <button
            type="button"
            onClick={onAction}
            className="mt-6 inline-flex rounded-xl bg-[#B6E23A] px-6 py-3 font-bold text-[#1a1a1a] transition-colors hover:bg-[#a3d130]"
        >
            {actionLabel}
        </button>

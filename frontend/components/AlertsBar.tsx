...
const normalizeAlertMeta = (alert: Alert): OperationalAlert => {
    ...
    switch (alert.sourceType) {
        ...
        case 'SANIDADE': return { ...alert, severity, chipLabel, title: alert.type === 'critical' ? 'Sanidade: vence hoje ou já venceu' : 'Sanidade: vence em até 7 dias', description: `${baseDescription}. Abra o Calendário da Sanidade para ver os animais e registrar a aplicação.`, sourceLabel: 'Sanidade', actionLabel: 'Abrir Calendário' };
